// Dummy demo data for the Near-Future Yard concept. Not wired to Sanity/config —
// this is a static contest mockup. Placeholder brands + fictional stock; no real
// contact details are stated as fact.
...
// warm/cool placeholder image gradients (no real photos)
const g = (a: string, b: string) => `linear-gradient(135deg, ${a}, ${b})`;

export const vehicles: Vehicle[] = [
  { id:'ry-01', year:2024, make:'Subaru', model:'Outback', variant:'AWD Touring', price:52990, odo:12, fuel:'Petrol', trans:'CVT Auto', body:'Wagon', drive:'AWD', condition:'Demo', hue:g('#3C5A78','#7C93AC'), aiLine:'Great all-weather tourer — full-time AWD and 213mm clearance suit gravel and highway alike.', badge:'Low km' },
  { id:'ry-02', year:2025, make:'Isuzu', model:'D-MAX', variant:'X-Terrain 4x4', price:67490, odo:0, fuel:'Diesel', trans:'6-sp Auto', body:'Ute', drive:'4x4', condition:'New', hue:g('#5A3F2E','#9A7B62'), aiLine:'3,500kg braked tow and a 3-year fixed-price service plan — a genuine work-and-tow pick.', badge:'Tow 3.5t' },
  { id:'ry-03', year:2023, make:'Hyundai', model:'Tucson', variant:'Elite N Line', price:41990, odo:28450, fuel:'Petrol', trans:'8-sp Auto', body:'SUV', drive:'FWD', condition:'Used', hue:g('#4A4E5A','#868C9C'), aiLine:'One-owner, full service history. Roomy family SUV with Apple CarPlay and a 5-star ANCAP rating.' },
  { id:'ry-04', year:2025, make:'Kia', model:'EV5', variant:'Earth AWD', price:58990, odo:15, fuel:'Electric', trans:'Single-speed', body:'SUV', drive:'AWD', condition:'New', hue:g('#2E5E57','#5FA79A'), aiLine:'555km WLTP range and V2L power — run your campsite off the car. Rebi rates this a top EV value.', badge:'EV · 555km' },
  ...
  { id:'ry-09', year:2021, make:'Jeep', model:'Wrangler', variant:'Rubicon', price:56990, odo:52300, fuel:'Petrol', trans:'8-sp Auto', body:'SUV', drive:'4x4', condition:'Used', hue:g('#4A4030','#8A7C60'), aiLine:'Serious trail-rated 4x4 with lockers and disconnecting sway bar. Rebi flags a recent major service.' },
];
...
// tiny inline icon set (stroke, 1.6) — returns SVG string
export const icon = (name: string, size = 16): string => {
  ...
  const p: Record<string,string> = {
    ...
    body: `<path d="M3 13l2-5a2 2 0 012-1h10a2 2 0 012 1l2 5"/><path d="M3 13h18v4H3z"/><circle cx="7.5" cy="17" r="1.5"/><circle cx="16.5" cy="17" r="1.5"/>`,
